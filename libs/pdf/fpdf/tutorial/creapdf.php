    ...
    if ($cotizacion) {
        if(mysql_num_rows($cotizacion) > 0){
            while ($info = mysql_fetch_array($cotizacion)) {
                ...
                if ($promo == 'prom1') {
                    $promo_valor_apto = $promo1f;
                    $promo_total_apto = $totalPromo1f;
                    $promo_separacion = $separacionPromo1;
                    $promo_cuota_inicial = $cuotaInicialPromo1;
                    $promo_saldo = $saldoPromo1;
                }else if($promo == 'prom2'){
                    $promo_valor_apto = $promo2f;
                    $promo_total_apto = $totalPromo2f;
                    $promo_separacion = $separacionPromo2;
                    $promo_cuota_inicial = $cuotaInicialPromo2;
                    $promo_saldo = $saldoPromo1;
                }else{
...
$pdf->Image('../../../img/cotizacion/apto_'.$variable.'_'.($totalFotos).'.jpg',16,67,93);
...
//doceava fila dato del descuento en la promocion
if ($promo == 'prom1') {
    $pdf->SetX(110);
    $pdf->SetTextColor(255,0,0);
    $pdf->Cell(40,8,'  Promoción',1,0,'L',true);
    $pdf->Cell(60,8,'  $ '.$valorDescuento1,1,0,'L',true);
    $pdf->Ln(8);
}else if ($promo == 'prom2') {
    $pdf->SetX(110);
    $pdf->SetTextColor(255,0,0);
    $pdf->Cell(40,8,'   Promoción',1,0,'L',true);
    $pdf->Cell(60,8,'  $ '.$valorDescuento2,1,0,'L',true);
    $pdf->Ln(8);
}else if ($prom == 'noprom') {
...
if ($promo == 'prom1') {
   ...
   $pdf->SetFillColor(155,155,154);
   $pdf->SetTextColor(255,255,255);
   $pdf->Cell(60,8,'  '.$totalPromo1f,1,0,'L',true);
   $pdf->Ln(18);
}else if ($promo == 'prom2') {
    $pdf->SetX(110);
    $pdf->Cell(40,8,'  '.$f13c1,1,0,'L',true);
    $pdf->SetFillColor(155,155,154);
    $pdf->SetTextColor(255,255,255);
    $pdf->Cell(60,8,'  '.$totalPromo2f,1,0,'L',true);
    $pdf->Ln(18);
}else if ($prom == 'noprom') {
   $pdf->SetX(110);
   $pdf->Cell(40,8,'  '.$f13c1,1,0,'L',true);
...
if ($promo == 'prom1') {
   ...
   $pdf->Cell(60,8,'  '.$separacionPromo1,1,0,'L',true);
   $pdf->Ln(8);
    ...
    $pdf->SetFillColor(148,177,62);
    $pdf->Cell(40,8,'  '.$f8c1,1,0,'L',true);
    $pdf->Cell(60,8,'  '.$separacionPromo2,1,0,'L',true);
    $pdf->Ln(8);
}else if ($prom == 'noprom') {
   $pdf->SetX(110);
   $pdf->SetFillColor(148,177,62);
...
if ($promo == 'prom1') {
    ...
    $pdf->Cell(60,8,'  '.$cuotaInicialPromo1,1,0,'L',true);
    $pdf->Ln(8);
}else if ($promo == 'prom2') {
    $pdf->SetX(110);
    $pdf->Cell(40,8,'  '.$f9c1,1,0,'L',true);
    $pdf->Cell(60,8,'  '.$cuotaInicialPromo2,1,0,'L',true);
    $pdf->Ln(8);
}else if ($prom == 'noprom') {
    $pdf->SetX(110);
    $pdf->Cell(40,8,'  '.$f9c1,1,0,'L',true);
...
if ($promo == 'prom1') {
    ...
    $pdf->Cell(60,8,'  '.$saldoPromo1,1,0,'L',true);
    $pdf->Ln(8);
}else if ($promo == 'prom2') {
    $pdf->SetX(110);
    $pdf->Cell(40,8,'  '.$f10c1,1,0,'L',true);
    $pdf->Cell(60,8,'  '.$saldoPromo2,1,0,'L',true);
    $pdf->Ln(8);
}else if ($prom == 'noprom') {
    $pdf->SetX(110);
    $pdf->Cell(40,8,'  '.$f10c1,1,0,'L',true);
